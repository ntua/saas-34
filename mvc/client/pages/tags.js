...
function TagsPage() {
  ...
  return (
    <Layout extra={false}>
      <Head>
        <title>Tags - Alex and Asimakis Overflow</title>
      </Head>

      <PageTitle title="Tags" borderBottom={false}>
        Tα tag μας βοηθάνε να κατηγοριοποιήσουμε τις ερωτήσεις σας.
      </PageTitle>
      ...
      {tags && (
        <>
          ...
          {tags.length == 0 && <p className="not-found">Δεν βρέθηκαν tag.</p>}
        </>
      )}
    </Layout>
  )
